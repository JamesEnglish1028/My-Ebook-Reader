...
const CatalogFilters: React.FC<CatalogFiltersProps> = ({
  ...
  return (
    <div className="theme-surface theme-border mb-5 rounded-xl border p-3">
        ...
        <div className="flex flex-wrap items-start gap-3">
          {showAudienceFilter && (
            <div className="flex flex-wrap items-center gap-2">
              <span className="theme-text-muted text-xs font-medium uppercase tracking-[0.12em]">Audience</span>
          ...
          {showFictionFilter && (
            <div className="flex flex-wrap items-center gap-2">
              <span className="theme-text-muted text-xs font-medium uppercase tracking-[0.12em]">Type</span>
              <div className="flex flex-wrap gap-1.5">
                {fictionOptions
                  .filter((option) => option.available)
                  .map((option) => (
          ...
          {showPublicationFilter && (
            <div className="flex flex-wrap items-center gap-2">
              <span className="theme-text-muted text-xs font-medium uppercase tracking-[0.12em]">Publication</span>
              <div className="flex flex-wrap gap-1.5">
          ...
          {showAvailabilityFilter && (
            <div className="flex flex-wrap items-center gap-2">
              <span className="theme-text-muted text-xs font-medium uppercase tracking-[0.12em]">Availability</span>
              <div className="flex flex-wrap gap-1.5">
          ...
          {showDistributorFilter && (
            <div className="flex flex-wrap items-center gap-2">
              <span className="theme-text-muted text-xs font-medium uppercase tracking-[0.12em]">Distributor</span>
              <div className="flex flex-wrap gap-1.5">
